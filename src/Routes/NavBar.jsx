  ...
  return (
    <nav className="nav" aria-label="Main menu">
      <div className="navLinksContainer">
        <a href="/" className="logo-link" aria-label="Entertainment Web App Home">
          <svg
            className="logo"
            width="33"
            height="27"
          ...
          >
            <title>Entertainment Web App Logo</title>
            <path
        ...
        <ul>
          <li>
            <NavLink 
              ...
              aria-label="Home"
            >
              <svg className="icon-nav" fill="white" aria-hidden="true">
          ...
          <li>
            <NavLink 
              ...
              aria-label="Movies"
            >
              <svg className="icon-nav" fill="#5A698F" aria-hidden="true">
          ...
          <li>
            ...
            >
              ...
              <span className="sr-only">Bookmarked Shows</span>
            </NavLink>
          </li>
        </ul>
