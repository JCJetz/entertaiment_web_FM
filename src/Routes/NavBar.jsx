  ...
  return (
    <nav className="nav">
      <div className="navLinksContainer">
        ...
        <ul>
          <li>
            <NavLink className="icon-nav" activeClassName="active" to="/">
              <svg className="icon-nav" fill="white">
          ...
          <li>
            <NavLink className="icon-nav" activeClassName="active" to="/movies">
              <svg className="icon-nav" fill="#5A698F">
